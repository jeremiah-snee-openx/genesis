---
title: '01. README iteration with an alignment loop'
description: 'A8 ALIGNMENT LOOP applied to README iteration. Single skill, single goal-steward thread. The smallest example in the gallery; minimal viable composition for a non-trivial documentation task.'
---
