---
title: '03. Release notes (minimum viable single skill)'
description: 'Cold-load run. Minimal output: 1 skill + 2 assets + 3 scripts. A9 SUPERVISED EXECUTION + S7 DETERMINISTIC TOOL BRIDGE + S4 VALIDATION DECORATOR. A1 PANEL considered and rejected; lens-count gate did not fire.'
---
