---
title: '05. PR review (verdict regime)'
description: 'Cold-load run. Same prompt as 04 with verdict required. Regime change: deterministic bridges, schema gate, post-emit verifier loop, graceful tool probes. A8 ALIGNMENT LOOP, B5 ESCALATION, R1 SPLIT considered and rejected.'
---
