---
title: '04. PR review (advisory panel)'
description: 'Cold-load run. Multi-primitive panel: 6 personas + 4 assets + 3 scripts + trigger + entrypoint + rule + evals. A6 EVENT-DRIVEN AGENT + A1 PANEL + DISSENT-WEIGHTED arbiter. R1 SPLIT considered, applied at lens content as R3 EXTRACT.'
---
