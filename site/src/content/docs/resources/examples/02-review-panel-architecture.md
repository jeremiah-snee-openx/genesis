---
title: '02. Re-architecting a review panel'
description: 'A re-architecture lesson. The original design ran every reviewer lens in one thread (FAN-OUT-IN-ONE-CONTEXT anti-pattern). The corrected design realizes A1 PANEL with B1 FAN-OUT + SYNTHESIZER.'
---
